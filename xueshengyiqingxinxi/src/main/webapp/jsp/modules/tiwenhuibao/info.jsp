            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">体温汇报登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xuexiaoValue" name="xuexiaoValue" class="form-control"
                                               v-model="ruleForm.xuexiaoValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="tiwenhuibaoTiwen" name="tiwenhuibaoTiwen" class="form-control"
                                               v-model="ruleForm.tiwenhuibaoTiwen" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>体温状态</label>
                                    <input id="tiwenValue" name="tiwenValue" class="form-control"
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "tiwenhuibao/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.tiwenhuibaoContent != null && ruleForm.tiwenhuibaoContent != 'null' && ruleForm.tiwenhuibaoContent != '') {
            var tiwenhuibaoContentUeditor = UE.getEditor('tiwenhuibaoContentEditor');
                tiwenhuibaoContentUeditor.ready(function () {
                    var mes = '' + ruleForm.tiwenhuibaoContent;
                    tiwenhuibaoContentUeditor.setContent(mes);
                    tiwenhuibaoContentUeditor.setDisabled('fullscreen');
            });
        }
    }
