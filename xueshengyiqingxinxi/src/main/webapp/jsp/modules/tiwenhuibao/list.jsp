...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">体温汇报管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">体温汇报管理</li>
                            <li class="breadcrumb-item active">体温汇报列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">体温汇报列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        体温状态
                                        <div class="layui-input-inline">
                                            <select name="tiwenTypesSelectSearch"  style="width: 150px;" id="tiwenTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(shifouTypesSelectSearchInput != null){
                ...
                //体温状态
            var tiwenTypesSelectSearchInput = document.getElementById("tiwenTypesSelectSearch");
            if(tiwenTypesSelectSearchInput != null){
                var tiwenTypesIndex = tiwenTypesSelectSearchInput.selectedIndex;
                if( tiwenTypesIndex  != 0){
                    searchForm.tiwenTypes= document.getElementById("tiwenTypesSelectSearch").options[tiwenTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("tiwenhuibao/page", "GET", {
                ...
                tiwenTypes: searchForm.tiwenTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //体温
            var tiwenhuibaoTiwenCell = document.createElement('td');
            tiwenhuibaoTiwenCell.innerHTML = item.tiwenhuibaoTiwen;
            row.appendChild(tiwenhuibaoTiwenCell);
            ...
            //体温状态
            var tiwenTypesCell = document.createElement('td');
            tiwenTypesCell.innerHTML = item.tiwenValue;
            row.appendChild(tiwenTypesCell);


                //详情信息
            var tiwenhuibaoContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.tiwenhuibaoContent && item.tiwenhuibaoContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.tiwenhuibaoContent.indexOf('<img');
                var endIndex = item.tiwenhuibaoContent.indexOf('>');
                    tiwenhuibaoContentCell.innerHTML = item.tiwenhuibaoContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.tiwenhuibaoContent != null && item.tiwenhuibaoContent != "" && item.tiwenhuibaoContent.length >= 11) {
                        tiwenhuibaoContentCell.innerHTML = item.tiwenhuibaoContent.substring(0, 10) + "...";
                } else {
                        tiwenhuibaoContentCell.innerHTML = item.tiwenhuibaoContent;
                }
            }
            row.appendChild(tiwenhuibaoContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("tiwenhuibao/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addtiwenhuibao", "addtiwenhuibao");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function tiwenTypesSelectSearch() {
            var tiwenTypesSelectSearch = document.getElementById('tiwenTypesSelectSearch');
            if(tiwenTypesSelectSearch != null) {
                tiwenTypesSelectSearch.add(new Option('-请选择-',''));
                if (tiwenTypesOptions != null && tiwenTypesOptions.length > 0){
                    for (var i = 0; i < tiwenTypesOptions.length; i++) {
                            tiwenTypesSelectSearch.add(new Option(tiwenTypesOptions[i].indexName,tiwenTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            ...
            function tiwenTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=tiwen_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        tiwenTypesOptions = res.data.list;
                    }
                });
            }
