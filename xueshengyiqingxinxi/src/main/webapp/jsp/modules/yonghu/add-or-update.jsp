                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>所属学校</label>
                                        <select id="xuexiaoTypesSelect" name="xuexiaoTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>身份证号</label>
...
<script>
    ...
    function setSelectOption() {
        ...
        if(xuexiaoTypesSelect != null && xuexiaoTypesOptions != null  && xuexiaoTypesOptions.length > 0 ) {
            for (var i = 0; i < xuexiaoTypesOptions.length; i++) {
                if (xuexiaoTypesOptions[i].codeIndex == ruleForm.xuexiaoTypes) {//下拉框value对比,如果一致就赋值汉字
                        xuexiaoTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
